...
// Se define el nombre de la colección a utilizar. Cada documento tiene como ID el correo del usuario
...
/*
	Ruta 2: Guardar/actualizar datos en la base mediante una petición de tipo POST.
	Ejemplo de una petición: https://ruta-de-tu-aplicacion.cloudfunctions.net/saveData
	let headers = {
